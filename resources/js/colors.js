...
export const gradientBgPurplePink = `${gradientBgBase} from-indigo-400 via-blue-500 to-blue-500`
export const gradientBgDark = `${gradientBgBase} from-slate-700 via-slate-900 to-slate-800`
export const gradientBgPinkRed = `${gradientBgBase} from-blue-400 via-blue-500 to-indigo-500`
...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
  const colors = {
    ...
    bg: {
      ...
      danger: 'bg-white dark:bg-red-500 text-red-500 dark:text-white',
      warning: 'bg-yellow-600 dark:bg-yellow-500 text-white',
      info: 'bg-gradient-to-r from-[#468ef9] to-[#0c66ee] text-white border-transparent'
    },
    bgHover: {
      ...
      danger:
        'hover:bg-red-500  hover:border-red-500 hover:dark:bg-white  hover:dark:border-red-600 hover:text-white',
      warning:
        'hover:bg-yellow-700 hover:border-yellow-700 hover:dark:bg-yellow-600 hover:dark:border-yellow-600',
      info: 'hover:bg-blue-700  hover:dark:bg-blue-600 hover:dark:border-blue-600'
    },
    borders: {
      white: 'border-white',
      ...
      info: 'border-transparent dark:border-blue-500'
    },
    text: {
